...
const SystemForm = (props) => {
    ...
    [
      {
        name: 'new',
        title: 'Save',
        class: 'btn btn-sm btn-success me-3 disabled'
      },
      {
        name: 'delete',
        title: 'Delete',
      ...
      },
      {
        name: 'copy',
        title: 'Copy',
        class: 'btn btn-sm btn-secondary me-3 disabled'
      }
    ]
  ...
  const scenarioParams = JSON.parse(formState.scenarioParams);
  const stakingParams = JSON.parse(formState.stakingParams);
  ...
  return (
    <section className="container">
      <div className="row">
        <ButtonToolbar buttons={buttonSettings} handleButtonClick={handleButtonClick} />
      </div>
      <form>
        <Tabs
          id="systemTabs"
            ...
            <div className="row">
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id=" sysform_eventTypeId" name="eventTypeId" value={formState.eventTypeId} required aria-required="true" onChange={handleChange}>
                ...
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id="sysform_scenario" name="scenario" value={formState.scenario[0].scenarioId} required aria-required="true" onChange={handleChange}>
                ...
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id="sysform_stakingPlan" name="stakingPlan" value={formState.stakingPlan[0].stakingId} required aria-required="true" onChange={handleChange}>
              ...
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="includeCommission" id="sysform_includeCommission" value={formState.includeCommission} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="isRacingEvent" id="sysform_isRacingEvent" value={formState.isRacingEvent} onChange={handleChange} />
                </div>
              </div>
            </div>
          </Tab>
            ...
            <div className="row">
              ...
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="savestats" id="sysform_savestats" value={formState.savestats} onChange={handleChange} />
                </div>
              </div>
            </div>
          </Tab>
            ...
            <div className="row">
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="timeSecsRace" id="sysform_timeSecsRace" max="3600" step="1" min="30" value={formState.timeSecsRace} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="minOdds" id="sysform_minOdds" value={formState.minOdds} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="maxOdds" id="sysform_maxOdds" value={formState.maxOdds} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="maxLiability" id="sysform_maxLiability" value={formState.maxLiability} onChange={handleChange} />
                </div>
              </div>
              <div className="col-6">
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="unsettledLimit" id="sysform_unsettledLimit" value={formState.unsettledLimit} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  <label className="form-label" id="sysform_minBookLayBets-lbl" htmlFor="sysform_minBookLayBets" title="0 = off.">Minimum Book Lay</label>
                  <input className="form-control w-75" type="number" name="minBookLayBets" id="sysform_minBookLayBets" value={formState.minBookLayBets} onChange={handleChange} />
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="betStartingPrice" id="sysform_betStartingPrice" value={formState.betStartingPrice} onChange={handleChange} />
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="text" name="scenario.title" id="sysform_scenarioTitle" value={formState.scenario[0].title} readOnly onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <textarea className="form-control w-75" name="scenario.description" id="sysform_scenarioDesc" cols="50" rows="6" value={formState.scenario[0].description} readOnly onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="scenarioParams.nthFavourite" id="sysform_scenarioParams_nthFavourite" value={scenarioParams.nthFavourite} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="scenarioParams.numFavourite" id="sysform_scenarioParams_numFavourite" value={scenarioParams.numFavourites} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="number" name="scenarioParams.exclude" id="sysform_scenarioParams_excFavourite" value={scenarioParams.exclude} onChange={handleChange} />
                </div>
              </div>
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-control w-75" type="text" name="stakingTitle" id="sysform_stakingTitle" value={formState.stakingPlan[0].title} readOnly onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <textarea className="form-control w-75" name="stakingDesc" id="sysform_stakingDesc" cols="50" rows="6" value={formState.stakingPlan[0].description} readOnly onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  <label className="form-label" id="sysform_stakingParams_stake-lbl" htmlFor="sysform_stakingParams_stake" title="Enter the amount to place on each bet">Stake Amount<span className="star">&#160;*</span></label>
                  <input className="form-control w-75" type="number" name="stakingParams.stake" id="sysform_stakingParams_stake" value={stakingParams.stake} required aria-required="true" onChange={handleChange} />
                </div>

                <div className="col-auto mb-3">
                  <label className="form-label" id="sysform_stakingParams_recovery-lbl" htmlFor="sysform_stakingParams_recovery" title="Choose recovery option if required">Recovery Option<span className="star">&#160;*</span></label>
                  <select className="form-control w-75" id="sysform_stakingParams_recovery" name="stakingParams.recovery" value={stakingParams.recovery} required aria-required="true" onChange={handleChange}>
                ...
                <div className="col-auto mb-3">
                  <label className="form-label" id="sysform_stakingParams_ordertype-lbl" htmlFor="sysform_stakingParams_ordertype" title="Order types are Limit Limit On Close or Market On Close">Order Type For Placed Bets<span className="star">&#160;*</span></label>
                  <select className="form-control w-75" id="sysform_stakingParams_ordertype" name="stakingParams.ordertype" value={stakingParams.orderType} required aria-required="true" onChange={handleChange}>
                ...
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id="sysform_stakingParams_persistancetype" name="stakingParams.persistance" value={stakingParams.persistance} required aria-required="true" onChange={handleChange}>
                ...
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id="sysform_stakingParams_timeinforce" name="stakingParams.timeInForce" value={stakingParams.timeInForce} required aria-required="true" onChange={handleChange}>
                    <option value=""></option>
                ...
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id="sysform_stakingParams_bettargettype" name="stakingParams.betTargetType" value='to do' required aria-required="true" onChange={handleChange}>
                    <option value=""></option>
            ...
            <div className="row">
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="turnInPlayEnabled" id="sysform_turnInPlayEnabled" value={formState.turnInPlayEnabled} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="inPlayOnly" id="sysform_inPlayOnly" value={formState.inPlayOnly} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id="sysform_marketBettingTypes" name="marketBettingTypes" value={formState.marketBettingTypes} required aria-required="true" onChange={handleChange}>
                    <option value=""></option>
                ...
                <div className="col-auto mb-3">
                  ...
                  <select className="form-control w-75" id="sysform_sort" name="sort" value={formState.sort} required aria-required="true" onChange={handleChange}>
                    <option value=""></option>
              ...
              <div className="col-6">
                ...
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="bspOnly" id="sysform_bspOnly" value={formState.bspOnly} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
                  ...
                  <input className="form-check-input ms-3" type="checkbox" name="customTime" id="sysform_customTime" value={formState.customTime} onChange={handleChange} />
                </div>
                <div className="col-auto mb-3">
