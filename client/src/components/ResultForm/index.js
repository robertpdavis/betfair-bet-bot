        ...
        <div className="row">
          <div className="col-6">
            <div className="col-auto mb-3">
              ...
              <input type="text" name="betId" id="resform_betId" value={result.betId} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="customerRef" id="resform_customerRef" value={result.customerRef} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="betPlaced" id="resform_betPlaced" value={result.betPlaced} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="orderType" id="resform_orderType" value={result.orderType} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="orderStatus" id="resform_orderStatus" value={result.orderStatus} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              <label className="form-label" id="resform_betType-lbl" htmlFor="resform_betType" title="&lt;strong&gt;Bet Type&lt;/strong&gt;"> Bet Type</label>
              <input type="text" name="betType" id="resform_betType" value={result.betType} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="racingBetType" id="resform_racingBetType" value={result.racingBetType} className="form-control w-75" size="30" readOnly />
            </div>
          </div>
          <div className="col-6">
            <div className="col-auto mb-3">
              ...
              <input type="text" name="eventName" id="resform_eventName" value={result.eventName} className="form-control w-75" size="50" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="eventId" id="resform_eventId" value={result.eventId} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="marketName" id="resform_marketName" value={result.marketName} className="form-control w-75" size="50" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="marketId" id="resform_marketId" value={result.marketId} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="selectionName" id="resform_selectionName" value={result.selectionName} className="form-control w-75" size="50" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="selectionId" id="resform_selectionId" value={result.selectionId} className="form-control w-75" size="30" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="persistence" id="resform_persistence" value={result.persistence} className="form-control w-75" size="15" readOnly />
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-6">
            <div className="col-auto mb-3">
              ...
              <input type="text" name="reqPrice" id="resform_reqPrice" value={(result.reqPrice / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="priceMatched" id="resform_priceMatched" value={(result.priceMatched / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="matchedDate" id="resform_matchedDate" value={result.matchedDate} className="form-control w-75" size="15" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="checkbox" name="priceReduced" id="resform_priceReduced" value={result.priceReduced} className="form-check-input ms-3" />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="liability" id="resform_liability" value={(result.liability / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
          </div>
          <div className="col-6">
            <div className="col-auto mb-3">
              ...
              <input type="text" name="size" id="resform_size" value={(result.size / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="sizeMatched" id="resform_sizeMatched" value={(result.sizeMatched / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="sizeRemaining" id="resform_sizeRemaining" value={(result.sizeRemaining / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="sizeLapsed" id="resform_sizeLapsed" value={(result.sizeLapsed / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="sizeVoided" id="resform_sizeVoided" value={(result.sizeVoided / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="sizeCancelled" id="resform_sizeCancelled" value={(result.sizeCancelled / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-6">
            <div className="col-auto mb-3">
              ...
              <input type="text" name="settledDate" id="resform_settledDate" value={result.settledDate} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="sizeSettled" id="resform_sizeSettled" value={(result.sizeSettled / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="commissionperc" id="resform_commissionperc" value={result.commissionperc} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="commission" id="resform_commission" value={(result.commission / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
          </div>
          <div className="col-6">
            <div className="col-auto mb-3">
              ...
              <input type="text" name="profitLoss" id="resform_profitLoss" value={(result.profitLoss / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="returned" id="resform_returned" value={(result.returned / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div>
            <div className="col-auto mb-3">
              ...
              <input type="text" name="wallet" id="resform_wallet" value={(result.wallet / 100).toFixed(2)} className="form-control w-75" size="10" readOnly />
            </div >
          </div >
        </div >
      </form >
